...
*/
@interface FPhiSelphIDWidget : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureMetadataOutputObjectsDelegate, FPhiGraphProtocol, NSXMLParserDelegate>
