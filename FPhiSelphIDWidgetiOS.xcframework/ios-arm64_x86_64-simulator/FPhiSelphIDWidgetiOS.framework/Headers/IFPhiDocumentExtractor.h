...
#import "FPhiSelphIDEncodedDataResult.h"
...
typedef NS_ENUM(NSInteger, IFPhiDocumentExtractorDiagnostic) {
    ...
    DIAGNOSTIC_ENCODED_FOCUS_NEEDED
};
...
@property (nonatomic) bool parsingNeeded;
@property (nonatomic) CGRect focusedEncodedDataRegion;
@property (nonatomic) NSMutableDictionary<NSString *, FPhiSelphIDEncodedDataResult *> *encodedDataResults;
-(id)init;
@end
