...
#import "FPhiDocumentExtractorManager.h"
...
@property (nonatomic) bool encodedDataFocusEnabled;
...
+(FPhiDocumentExtractorManager *)getDocumentExtractorManager;
+(void)setDocumentExtractorManager:(FPhiDocumentExtractorManager *)v;
